...
CREATE TABLE IF NOT EXISTS `event_locations` (
  `id_event_location` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `event_ticket` (
  `idevent_ticket` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `favourite_event` (
  `idfavourite_event` INT NOT NULL AUTO_INCREMENT,
  `FK_idevent` INT NOT NULL,
  `FK_iduser` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `order_ticket` (
  `idorder_ticket` INT NOT NULL AUTO_INCREMENT,
